...
static uint64_t multisynth_calc(uint64_t freq, uint64_t pll_freq, struct Si5351RegSet *reg)
{
  uint64_t lltmp;
  uint32_t a, b, c, p1, p2, p3;
  uint8_t divby4 = 0;
...
static uint64_t multisynth67_calc(uint64_t freq, uint64_t pll_freq, struct Si5351RegSet *reg)
{
  //uint8_t p1;
  // uint8_t ret_val = 0;
  uint32_t a;
...
static void update_sys_status(struct Si5351Status *status)
{
  uint8_t reg_val = 0;
...
static void update_int_status(struct Si5351IntStatus *int_status)
{
  uint8_t reg_val = 0;
...
static void ms_div(enum si5351_clock clk, uint8_t r_div, uint8_t div_by_4)
{
  uint8_t reg_val = 0;
    uint8_t reg_addr = 0;
