...
lRawDma_t mainL_dma = {.ledCount = MAIN_L_LDCNT, .rawCount = RAW_LDCNT, .lRaw = rawLeds2, .rawTxCount = RAW_DMA_CNT};
lRawDma_t mainR_dma = {.ledCount = MAIN_R_LDCNT, .rawCount = RAW_LDCNT, .lRaw = rawLeds3, .rawTxCount = RAW_DMA_CNT};
