 ...
 * Timestamp:                                          2026-01-19 18:54:40 GMT+01:00
 *
 ...
 * 
 * Part:               Si5351A
 * Project File:       D:\eclipse_wrk\mandelLed\Si5351\Si5351A-RevB-Project.slabtimeproj
 * Created By:         ClockBuilder Pro v4.17 [2025-11-06]
 * Timestamp:          2026-01-19 18:54:40 GMT+01:00
 * 
 * Design Rule Check
 ...
 * 
 * Warnings:
 * - OUT0 [145 kHz] and OUT1 [165 kHz] may have coupling [1]
 * - OUT0 [145 kHz] and OUT2 [180 kHz] may have coupling [1]
 * - OUT1 [165 kHz] and OUT2 [180 kHz] may have coupling [1]
 * - The desired configuration is too large to fit into NVM for a factory
 *   Programmed part. You can, however, still export the configuration and
 *   program the part through I2C.
 * 
 * Footnotes:
 ...
 *       R              = 4  (2^2)
 *       Fout           = 145 kHz
 *       N              = 1551.7241379310344827... [ 1551 + 21/29 ]
 *    Output1:
 *       Features       = None
 *       Disabled State = StopLow
 *       R              = 4  (2^2)
 *       Fout           = 165 kHz
 *       N              = 1363.6363636363636363... [ 1363 + 7/11 ]
 *    Output2:
 *       Features       = None
 *       Disabled State = StopLow
 *       R              = 4  (2^2)
 ...
 * 0x002C[17:0]  MS0_P1          198108             0x305DC          
 * 0x002C[6:4]   R0_DIV          2                  0x2              
 * 0x002F[19:0]  MS0_P2          20                 0x00014          
 * 0x002F[23:4]  MS0_P3          29                 0x0001D          
 * 0x0034[17:0]  MS1_P1          174033             0x2A7D1          
 * 0x0034[6:4]   R1_DIV          2                  0x2              
 * 0x0037[19:0]  MS1_P2          5                  0x00005          
 * 0x0037[23:4]  MS1_P3          11                 0x0000B          
 * 0x003C[17:0]  MS2_P1          159488             0x26F00          
