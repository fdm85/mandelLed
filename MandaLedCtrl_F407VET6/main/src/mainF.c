...
static const uBrdg_Leaf mtrx[6] = { {.gtFp = NULL, .des = "anim_matrix", .par = (uint32_t*)&anim_matrix, .pCt = 3},
                              {.gtFp = enDisAble, .des = "OnOff", .par = &enabledMatrix, .pCt = 1},
                              {.gtFp = triggerTime, .des = "trgIntervall(100us)", .par = &trgTimeMatrix, .pCt = 1},
